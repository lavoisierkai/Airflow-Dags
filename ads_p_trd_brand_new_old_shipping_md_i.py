...
datebase = 'access_ads'
tableName = "ads_p_trd_brand_new_old_shipping_md_i"
...
SELECT  
    ...
    goods_type as goods_type_id,
    level_by_order ,
    pmt_gmv_md as gmv,
    pmt_refund_goods_amount_md as refund_gmv,
    pmt_goods_cnt_coll_md as unit_sold,
    pmt_user_cnt_md as customer_cnt,
    pmt_order_cnt_md as order_cnt,
    pmt_goods_cnt_md as sku_cnt 
