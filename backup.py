...
# datebase = 'access_cdm'
# tableName = "dim_item_goods_barcode_dh_f"
...
#     description="first offical version",
...
# querry = '''
# SELECT * FROM {datebase}.{tableName} where dt='{dt}'
...
#     python_callable=CheckTableExists.check_table_exists, 
...
# check_table_exists >> [compare_to_dt, get_impala]
